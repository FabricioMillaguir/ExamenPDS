...
public class UsuarioDAO {
	...
	public static boolean save(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ExamenPDSPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ExamenPDSPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Usuario usuario)throws PersistentException {
		try {
			orm.Token[] lTokens = usuario.token.toArray();
			for(int i = 0; i < lTokens.length; i++) {
				lTokens[i].setUsuario(null);
			}
	...
	public static boolean refresh(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ExamenPDSPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Usuario usuario) throws PersistentException {
		try {
			orm.ExamenPDSPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
