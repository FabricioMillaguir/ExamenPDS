...
public class ExamenPDSPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ExamenPDS";
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm.Token.class);
		configuration.addAnnotatedClass(orm.Palabra.class);
		configuration.addAnnotatedClass(orm.Consulta.class);
		configuration.addAnnotatedClass(orm.Traduccion.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ExamenPDSPersistentManager();
		}
